    ...
    <div v-if="!submitted">
      ...
      <div class="form-group">
        ...
        <input
          ...
          required
          v-model="client.EmergencyContactFirstName"
        ...
        <input
          ...
          required
          v-model="client.EmergencyContactLastName"
        ...
        <input
          ...
          required
          v-model="client.EmergencyContactPhone"
  ...
  methods: {
    saveClient() {
      ...
      ClientDataService.create(data)
        .then(response => {
          this.client.ClientID = response.data.ClientID;
