<template>
    <div class="about">
                ...
                <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end"
                    ...
                    <div class="one-forth d-flex js-fullheight align-items-center ftco-animate"
                        ...
                        <div class="text mt-md-5">
                            <h1 class="mb-4">Be the BEST <br> Version of YOU</h1>
                            <p>Fitness is not about being better than someone. Fitness is about being better than the
                                person you were yesterday.</p>
                            <p><a href="/service" class="btn btn-primary px-4 py-3 mt-3">Book A Session</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-sm-5 img img-2 d-flex align-items-center justify-content-center justify-content-md-end"
                        style="background-image: url(images/cover3.jpg); position: relative"></div>
                    <div class="col-sm-7 wrap-about py-5 ftco-animate">
                        ...
                        <div class="pl-lg-5 ml-md-5">
                            <p>Keep on track with your goals and progress with our PhyZeke Presidental Fitness. We will
                                set you up with your own profile and login for you to post daily meal and exercise
                                tracking, book sessions, or contact your trainer with any questions.</p>
        ...
        <section class="ftco-section ftco-counter img" id="section-counter"
            style="background-image: url(images/cover4.jpg);" data-stellar-background-ratio="0.5">
            <div class="container">
        ...
        <!-- Testimonial -->
        <section class="ftco-section testimony-section" style="background-image: url(images/cover5.jpg);"
            data-stellar-background-ratio="10">
            <div class="container">
                <div class="row justify-content-center mb-5 pb-2">
        ...
        <!-- Make Appointment -->
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-5 ftco-animate img img-2" style="background-image: url(images/cover10.jpg);">
                    </div>
